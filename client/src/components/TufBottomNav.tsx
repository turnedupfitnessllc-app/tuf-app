...
export function TufBottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-[#0e0e0e] border-t-2 border-[#8B0000] flex z-50"
        ...
        return (
          <a
            ...
            className={`flex-1 py-2 px-1 border-t-2 border-transparent -mt-0.5 flex flex-col items-center gap-0.5 cursor-pointer transition-all ${
              isActive ? "text-[#C8973A] border-t-[#C8973A]" : "text-[#333333]"
            }`}
            style={
              isActive
                ? {
