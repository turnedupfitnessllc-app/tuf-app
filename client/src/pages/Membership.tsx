...
const TIERS = [
  ...
  },
  {
    ...
    features: ["AI Corrective Coaching", "MOVE Pillar", "FUEL Pillar", "Pain Diagnostics", "Full Exercise Library"],
    cta: "GET CORE →",
    ctaRoute: "/pricing",
    highlight: false,
  },
  {
    ...
    features: ["Everything in Core", "FEAST Pillar — TUTK Recipes", "100-Recipe Library", "1,800-Food Database", "Georgia/Southern Food Intelligence"],
    cta: "GET ELITE →",
    ctaRoute: "/pricing",
    highlight: true,
  },
  {
    ...
    features: ["Everything in Elite", "MINDSET Pillar", "30-Day Challenge", "Trainer Tools", "Client Management"],
    cta: "GET PRO →",
    ctaRoute: "/pricing",
    highlight: false,
  },
