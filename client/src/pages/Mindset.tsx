...
export default function Mindset() {
  ...
  const phaseColor = phaseCfg ? PHASE_COLORS[phaseCfg.phase] : "#FF4500";
      ...
      <div style={{ minHeight: "100vh", background: "var(--bg-primary)", padding: "0 16px 80px" }}>
        ...
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 32 }}>
            {[
              { phase: 1, days: "Days 1–7", theme: "Control > Chaos", color: "#FF4500" },
              ...
              { phase: 6, days: "Days 29–30", theme: "Become Dangerous", color: "#FF4500" },
            ].map(p => (
          ...
          <button
            onClick={handleStart}
            style={{ width: "100%", padding: "18px 24px", background: "#FF4500", border: "none", borderRadius: 14, color: "#fff", fontFamily: "'Barlow Condensed', sans-serif", fontSize: 18, fontWeight: 900, letterSpacing: "0.12em", cursor: "pointer" }}
          >
            BEGIN THE CHALLENGE →
          </button>
        </div>
  ...
  if (screen === "completed") {
    return (
      <div style={{ minHeight: "100vh", background: "var(--bg-primary)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 24px", textAlign: "center" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 32, width: "100%", maxWidth: 360 }}>
            {[
              ...
              <div key={stat.label} style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 10, padding: "12px 8px", textAlign: "center" }}>
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 28, color: "#FF4500" }}>{stat.value}</div>
        ...
        <button onClick={() => navigate("/")} style={{ padding: "16px 40px", background: "#FF4500", border: "none", borderRadius: 12, color: "#fff", fontFamily: "'Barlow Condensed', sans-serif", fontSize: 16, fontWeight: 900, letterSpacing: "0.12em", cursor: "pointer" }}>
            ...
            {phaseCfg && (
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {[
                    { key: "move", label: "MOVE", value: moveAnchor, set: setMoveAnchor, anchor: phaseCfg.moveAnchor, color: "#FF4500" },
