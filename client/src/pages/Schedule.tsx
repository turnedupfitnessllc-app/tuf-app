...
import { PantherAlarmCard } from "@/components/PantherAlarmCard";
import type { AlarmEntry } from "@/components/PantherAlarmCard";
...
// AlarmEntry is imported from PantherAlarmCard
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)", paddingBottom: 80 }}>
      ...
      <div className="sched-page" style={{ maxWidth: 480, margin: "0 auto", padding: "0 16px" }}>
        ...
        <PantherAlarmCard
          ...
          onAlarmsChange={(alarms) => save({ ...state, alarms })}
          onNotifGranted={() => {
            setNotifStatus("granted");
            save({ ...state, notificationsEnabled: true });
          }}
